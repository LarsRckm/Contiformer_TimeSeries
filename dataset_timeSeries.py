...
class TimeSeriesDataset_Interpolation_roundedInput(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask = remove_parts_of_graph_encoder(self.x_values,y_noise_spline, [self.args.interpolation_min_width, self.args.interpolation_max_width, self.args.interpolation_max_count], self.args.offset, [self.args.x_lim_low, self.args.x_lim_high])
        # print((mask == 0).sum())
